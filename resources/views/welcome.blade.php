...
<head>
    <meta charset="utf-8" />
    <title>{{ config('app.name', 'Product Review Tool') }}</title>
...
<body>
    ...
    <section class="section">
        @guest
            <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm justify-content-md-end pr-5 mb-5">
        ...
        <div class="container">
            <div class="container px-4 py-5" id="featured-3">
                <h2 class="pb-2 border-bottom">All Products List</h2>
                <div class="row g-4 py-5 row-cols-1 row-cols-lg-3">
                    ...
                    @empty
                        <p>Currently! There is no products for show</p>
                    @endforelse
